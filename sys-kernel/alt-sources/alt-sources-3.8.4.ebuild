...
src_prepare()
{
	epatch ${FILESDIR}/${PV}/${PN}-3.8-01-stable-${PV}.patch.bz2 || die "std-sources stable patch failed."
	epatch ${FILESDIR}/${PV}/${PN}-3.8-02-fc17.patch.bz2 || die "std-sources fedora patch failed."
	epatch ${FILESDIR}/${PV}/${PN}-3.8-03-aufs.patch.bz2 || die "std-sources aufs patch failed."
}
